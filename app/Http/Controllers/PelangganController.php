...
class PelangganController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('pelanggan.index', compact(['products', 'customor']));
    }

    public function bayar()
    {
        $booking = booking::with('user')->where('id_users', Auth::user()->id)->get();
    ...
    {
        $booking = booking::with('status', 'user', 'products')->where('id_users', Auth::user()->id)->get();
