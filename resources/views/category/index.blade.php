            ...
            <div class="table-responsive">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>{{ $p->name }}</td>
                        <td>
                            <a href="#" data-id="{{ $p->id }}" data-name="{{ $p->name }}" data-toggle="modal" data-target="#edit"><i class="fas fa-edit"></i></a>
            ...
            <div class="modal-content">
                <form action="{{ route('category-store') }}" method="POST">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title"><span>Tambah</span> Data Catgeory</h5>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <form action="{{ route('category-update') }}" method="POST">
                        ...
                        <input type="hidden" name="id">
                        <div class="modal-header">
                            <h5 class="modal-title"><span>Ubah</span> Data Category</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
