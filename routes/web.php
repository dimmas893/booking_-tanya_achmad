...
Route::put('/category/update', [App\Http\Controllers\CategoryController::class, 'update'])->middleware(['auth'])->name('category-update');
Route::delete('/category/delete', [App\Http\Controllers\CategoryController::class, 'destroy'])->middleware(['auth'])->name('category-delete');
